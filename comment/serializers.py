...
class CreateCommentSerializer(serializers.ModelSerializer):
    ...
    def validate(self, attrs):
        ...
        is_bartender = Bartender.objects.filter(cafe=cafe, user=user,is_active=True).exists()
    ...
    def create(self, validated_data):
        ...
        try:
            ...
            response = Comment.objects.create(
                user=user,cafe_id=comment.cafe_id
                ,is_cafe=True,date=now_date
                ,text=text,item_id=comment.item_id)
