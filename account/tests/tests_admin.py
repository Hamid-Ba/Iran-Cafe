...
class AdminUserTest(TestCase):
    """Test For Admin User"""
    def setUp(self):
        self.admin = get_user_model().objects.create_superuser(phone="09151498722",password="123456")
        self.client = Client()

        self.client.force_login(self.admin)

        self.user = get_user_model().objects.create_user(phone="09151498712",fullName="Test User")
