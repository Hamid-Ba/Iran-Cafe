...
class Payment(models.Model):
    ...
    status = models.PositiveSmallIntegerField(choices=PaymentStatus.choices,default=PaymentStatus.PAYMENT_CREATED)

    cafe = models.ForeignKey(cafe_models.Cafe,on_delete=models.CASCADE,related_name='payments')
    plan = models.ForeignKey(plan_models.Plan,on_delete=models.CASCADE,related_name='payments')
